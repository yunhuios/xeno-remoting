...
public class RemoteProxyUtils_extractDirectly_Test {

	@Test
	public void testAbnormal() throws ClassNotFoundException {

		try {
			RemoteProxyUtils.extractDirectly(null, null);
			Assert.fail();
		...
		try {
			RemoteProxyUtils.extractDirectly(null, new ArrayList<String>());
			Assert.fail();
		...
		Assert.assertEquals(0, RemoteProxyUtils.extractDirectly(new File("C:\\" + UUID.randomUUID().toString()), null).size());
		Assert.assertEquals(0, RemoteProxyUtils.extractDirectly(new File("C:\\" + UUID.randomUUID().toString()), new ArrayList<String>()).size());
		Assert.assertEquals(0, RemoteProxyUtils.extractDirectly(new File("C:\\" + UUID.randomUUID().toString() + ".txt"), null).size());
		Assert.assertEquals(0, RemoteProxyUtils.extractDirectly(new File("C:\\" + UUID.randomUUID().toString() + ".txt"), new ArrayList<String>()).size());
	}

	@Test
	public void testNormal1() throws ClassNotFoundException, URISyntaxException {
		File dir = new File(Thread.currentThread().getClass().getResource("/").toURI());
		Assert.assertTrue(dir.exists() && dir.isDirectory());

		List<String> excludes = getReservedExcludes();

		Set<Class> classes = RemoteProxyUtils.extractDirectly(dir, excludes);
	...
	@Test
	public void testNormal2() throws ClassNotFoundException, URISyntaxException {
		File dir = new File(Thread.currentThread().getClass().getResource("/").toURI());
		Assert.assertTrue(dir.exists() && dir.isDirectory());
	...
	@Test
	public void testNormal3() throws ClassNotFoundException, URISyntaxException {
		File dir = new File(Thread.currentThread().getClass().getResource("/").toURI());
		Assert.assertTrue(dir.exists() && dir.isDirectory());
	...
	@Test
	public void testNormal4() throws ClassNotFoundException, URISyntaxException {
		File dir = new File(Thread.currentThread().getClass().getResource("/").toURI());
		Assert.assertTrue(dir.exists() && dir.isDirectory());
	...
	@Test
	public void testNormal5() throws ClassNotFoundException, URISyntaxException {
		File dir = new File(Thread.currentThread().getClass().getResource("/").toURI());
		Assert.assertTrue(dir.exists() && dir.isDirectory());
	...
	private static List<String> getReservedExcludes() {
		List<String> excludes = new ArrayList<String>();
		excludes.add("org.showcase.*");
