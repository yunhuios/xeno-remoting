...
class SessionFilteredJavaScriptCallback extends AbstractJavaScriptCallback {
	 ...
	 */
	public SessionFilteredJavaScriptCallback(String[] sessionIds) throws IllegalArgumentException {
	...
	public void invoke(JavaScriptFunction... functions) throws IllegalArgumentException {
		...
		invokeAsync(MessageServlet.getReverseAjaxThreadPool().getBySessionIds(sessionIds), functions);
	}
